...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ChoicePlotPreReq'
        db.create_table('lok_choiceplotprereq', (
        ...
        db.send_create_signal('lok', ['ChoicePlotPreReq'])


    def backwards(self, orm):
        # Deleting model 'ChoicePlotPreReq'
        db.delete_table('lok_choiceplotprereq')
