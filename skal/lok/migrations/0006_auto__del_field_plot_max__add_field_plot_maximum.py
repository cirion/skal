...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Plot.max'
        db.delete_column('lok_plot', 'max')

        # Adding field 'Plot.maximum'
        db.add_column('lok_plot', 'maximum',
                      self.gf('django.db.models.fields.IntegerField')(default=2),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Plot.max'
        db.add_column('lok_plot', 'max',
                      self.gf('django.db.models.fields.IntegerField')(default=2),
                      keep_default=False)

        # Deleting field 'Plot.maximum'
        db.delete_column('lok_plot', 'maximum')
    ...
    models = {
        ...
        'lok.plot': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'maximum': ('django.db.models.fields.IntegerField', [], {'default': '2'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
            'visible': ('django.db.models.fields.BooleanField', [], {'default': 'False'})
        },
        'lok.plotoutcome': {
