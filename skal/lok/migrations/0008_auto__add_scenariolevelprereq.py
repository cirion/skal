...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ScenarioLevelPreReq'
        db.create_table('lok_scenariolevelprereq', (
            ...
            ('maximum', self.gf('django.db.models.fields.IntegerField')(default=1000)),
        ))
        db.send_create_signal('lok', ['ScenarioLevelPreReq'])


    def backwards(self, orm):
        # Deleting model 'ScenarioLevelPreReq'
        db.delete_table('lok_scenariolevelprereq')
