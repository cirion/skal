...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('lok_equipment', (
            ('item_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['lok.Item'], unique=True, primary_key=True)),
            ('type', self.gf('django.db.models.fields.IntegerField')()),
        ))
        db.send_create_signal('lok', ['Equipment'])

        # Adding model 'EquipmentStat'
        db.create_table('lok_equipmentstat', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('equipment', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['lok.Equipment'])),
            ('stat', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['lok.Stat'])),
            ('amount', self.gf('django.db.models.fields.IntegerField')()),
        ))
        db.send_create_signal('lok', ['EquipmentStat'])

        # Adding field 'Item.sellable'
        db.add_column('lok_item', 'sellable',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'Character.sword'
        db.add_column('lok_character', 'sword',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['lok.Equipment'], null=True, blank=True),
                      keep_default=False)

        # Adding unique constraint on 'Character', fields ['name']
        db.create_unique('lok_character', ['name'])


    def backwards(self, orm):
        # Removing unique constraint on 'Character', fields ['name']
        db.delete_unique('lok_character', ['name'])

        # Deleting model 'Equipment'
        db.delete_table('lok_equipment')

        # Deleting model 'EquipmentStat'
        db.delete_table('lok_equipmentstat')

        # Deleting field 'Item.sellable'
        db.delete_column('lok_item', 'sellable')

        # Deleting field 'Character.sword'
        db.delete_column('lok_character', 'sword_id')
    ...
    models = {
        ...
        'lok.character': {
            ...
            'sword': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['lok.Equipment']", 'null': 'True', 'blank': 'True'}),
