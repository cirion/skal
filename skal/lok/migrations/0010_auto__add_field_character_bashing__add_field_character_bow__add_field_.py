...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Character.bashing'
        db.add_column('lok_character', 'bashing',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='+', null=True, to=orm['lok.Equipment']),
                      keep_default=False)

        # Adding field 'Character.bow'
        db.add_column('lok_character', 'bow',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='+', null=True, to=orm['lok.Equipment']),
                      keep_default=False)

        # Adding field 'Character.feet'
        db.add_column('lok_character', 'feet',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='+', null=True, to=orm['lok.Equipment']),
                      keep_default=False)

        # Adding field 'Character.cloak'
        db.add_column('lok_character', 'cloak',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='+', null=True, to=orm['lok.Equipment']),
                      keep_default=False)

        # Adding field 'Character.clothing'
        db.add_column('lok_character', 'clothing',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='+', null=True, to=orm['lok.Equipment']),
                      keep_default=False)

        # Adding field 'Character.gloves'
        db.add_column('lok_character', 'gloves',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='+', null=True, to=orm['lok.Equipment']),
                      keep_default=False)

        # Adding field 'Character.ring'
        db.add_column('lok_character', 'ring',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='+', null=True, to=orm['lok.Equipment']),
                      keep_default=False)

        # Adding field 'Character.neck'
        db.add_column('lok_character', 'neck',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='+', null=True, to=orm['lok.Equipment']),
                      keep_default=False)

        # Adding field 'Character.armor'
        db.add_column('lok_character', 'armor',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='+', null=True, to=orm['lok.Equipment']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Character.bashing'
        db.delete_column('lok_character', 'bashing_id')

        # Deleting field 'Character.bow'
        db.delete_column('lok_character', 'bow_id')

        # Deleting field 'Character.feet'
        db.delete_column('lok_character', 'feet_id')

        # Deleting field 'Character.cloak'
        db.delete_column('lok_character', 'cloak_id')

        # Deleting field 'Character.clothing'
        db.delete_column('lok_character', 'clothing_id')

        # Deleting field 'Character.gloves'
        db.delete_column('lok_character', 'gloves_id')

        # Deleting field 'Character.ring'
        db.delete_column('lok_character', 'ring_id')

        # Deleting field 'Character.neck'
        db.delete_column('lok_character', 'neck_id')

        # Deleting field 'Character.armor'
        db.delete_column('lok_character', 'armor_id')
