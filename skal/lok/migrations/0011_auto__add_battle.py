...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Battle'
        db.create_table('lok_battle', (
            ('scenario_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['lok.Scenario'], unique=True, primary_key=True)),
            ('enemy', self.gf('django.db.models.fields.IntegerField')()),
            ('strength', self.gf('django.db.models.fields.IntegerField')()),
        ))
        db.send_create_signal('lok', ['Battle'])


    def backwards(self, orm):
        # Deleting model 'Battle'
        db.delete_table('lok_battle')
