...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'RouteItemFree'
        db.create_table('lok_routeitemfree', (
            ('routeoption_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['lok.RouteOption'], unique=True, primary_key=True)),
            ('item', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['lok.Item'])),
        ))
        db.send_create_signal('lok', ['RouteItemFree'])

        # Adding model 'LearnLocationOutcome'
        db.create_table('lok_learnlocationoutcome', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('location', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['lok.Location'])),
        ))
        db.send_create_signal('lok', ['LearnLocationOutcome'])

        # Adding model 'ScenarioLocationPreReq'
        db.create_table('lok_scenariolocationprereq', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('scenario', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['lok.Scenario'])),
            ('location', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['lok.Location'])),
        ))
        db.send_create_signal('lok', ['ScenarioLocationPreReq'])

        # Adding model 'ScenarioLocationKnownPreReq'
        db.create_table('lok_scenariolocationknownprereq', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('scenario', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['lok.Scenario'])),
            ('location', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['lok.Location'])),
            ('known', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        db.send_create_signal('lok', ['ScenarioLocationKnownPreReq'])

        # Adding model 'LocationRoute'
        db.create_table('lok_locationroute', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('origin', self.gf('django.db.models.fields.related.ForeignKey')(related_name='+', to=orm['lok.Location'])),
            ('destination', self.gf('django.db.models.fields.related.ForeignKey')(related_name='+', to=orm['lok.Location'])),
        ))
        db.send_create_signal('lok', ['LocationRoute'])

        # Adding model 'RouteItemCost'
        db.create_table('lok_routeitemcost', (
            ('routeoption_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['lok.RouteOption'], unique=True, primary_key=True)),
            ('item', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['lok.Item'])),
            ('amount', self.gf('django.db.models.fields.IntegerField')()),
        ))
        db.send_create_signal('lok', ['RouteItemCost'])

        # Adding model 'ScenarioLocationTypePreReq'
        db.create_table('lok_scenariolocationtypeprereq', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('scenario', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['lok.Scenario'])),
            ('type', self.gf('django.db.models.fields.IntegerField')()),
        ))
        db.send_create_signal('lok', ['ScenarioLocationTypePreReq'])

        # Adding model 'RouteOption'
        db.create_table('lok_routeoption', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('route', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['lok.LocationRoute'])),
            ('description', self.gf('django.db.models.fields.CharField')(max_length=1000)),
        ))
        db.send_create_signal('lok', ['RouteOption'])

        # Adding model 'CharacterLocationAvailable'
        db.create_table('lok_characterlocationavailable', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('character', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['lok.Character'])),
            ('location', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['lok.Location'])),
        ))
        db.send_create_signal('lok', ['CharacterLocationAvailable'])

        # Adding model 'Location'
        db.create_table('lok_location', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('type', self.gf('django.db.models.fields.IntegerField')()),
        ))
        db.send_create_signal('lok', ['Location'])

        # Adding model 'RouteToll'
        db.create_table('lok_routetoll', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('amount', self.gf('django.db.models.fields.IntegerField')()),
        ))
        db.send_create_signal('lok', ['RouteToll'])

        # Adding model 'SetLocationOutcome'
        db.create_table('lok_setlocationoutcome', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('location', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['lok.Location'])),
        ))
        db.send_create_signal('lok', ['SetLocationOutcome'])


    def backwards(self, orm):
        # Deleting model 'RouteItemFree'
        db.delete_table('lok_routeitemfree')

        # Deleting model 'LearnLocationOutcome'
        db.delete_table('lok_learnlocationoutcome')

        # Deleting model 'ScenarioLocationPreReq'
        db.delete_table('lok_scenariolocationprereq')

        # Deleting model 'ScenarioLocationKnownPreReq'
        db.delete_table('lok_scenariolocationknownprereq')

        # Deleting model 'LocationRoute'
        db.delete_table('lok_locationroute')

        # Deleting model 'RouteItemCost'
        db.delete_table('lok_routeitemcost')

        # Deleting model 'ScenarioLocationTypePreReq'
        db.delete_table('lok_scenariolocationtypeprereq')

        # Deleting model 'RouteOption'
        db.delete_table('lok_routeoption')

        # Deleting model 'CharacterLocationAvailable'
        db.delete_table('lok_characterlocationavailable')

        # Deleting model 'Location'
        db.delete_table('lok_location')

        # Deleting model 'RouteToll'
        db.delete_table('lok_routetoll')

        # Deleting model 'SetLocationOutcome'
        db.delete_table('lok_setlocationoutcome')
