...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('lok_character', 'location',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['lok.Location']),
                      keep_default=False)

        # Adding unique constraint on 'Location', fields ['name']
        db.create_unique('lok_location', ['name'])


    def backwards(self, orm):
        # Removing unique constraint on 'Location', fields ['name']
        db.delete_unique('lok_location', ['name'])

        # Deleting field 'Character.location'
        db.delete_column('lok_character', 'location_id')
