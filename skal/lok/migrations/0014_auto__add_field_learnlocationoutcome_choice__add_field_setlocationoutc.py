...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'LearnLocationOutcome.choice'
        db.add_column('lok_learnlocationoutcome', 'choice',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['lok.Result']),
                      keep_default=False)

        # Adding field 'SetLocationOutcome.choice'
        db.add_column('lok_setlocationoutcome', 'choice',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['lok.Result']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'LearnLocationOutcome.choice'
        db.delete_column('lok_learnlocationoutcome', 'choice_id')

        # Deleting field 'SetLocationOutcome.choice'
        db.delete_column('lok_setlocationoutcome', 'choice_id')
