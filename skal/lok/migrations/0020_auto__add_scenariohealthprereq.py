...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ScenarioHealthPreReq'
        db.create_table('lok_scenariohealthprereq', (
        ...
        db.send_create_signal('lok', ['ScenarioHealthPreReq'])


    def backwards(self, orm):
        # Deleting model 'ScenarioHealthPreReq'
        db.delete_table('lok_scenariohealthprereq')
