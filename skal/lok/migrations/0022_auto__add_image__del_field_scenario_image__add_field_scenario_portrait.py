...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Image'
        db.create_table('lok_image', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('title', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('alt', self.gf('django.db.models.fields.CharField')(max_length=500)),
            ('contributor', self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True)),
            ('contributor_link', self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True)),
            ('image', self.gf('django.db.models.fields.files.ImageField')(max_length=100)),
        ))
        db.send_create_signal('lok', ['Image'])

        # Deleting field 'Scenario.image'
        db.delete_column('lok_scenario', 'image')

        # Adding field 'Scenario.portrait'
        db.add_column('lok_scenario', 'portrait',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['lok.Image'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'Result.portrait'
        db.add_column('lok_result', 'portrait',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['lok.Image'], null=True, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_table('lok_image')

        # Adding field 'Scenario.image'
        db.add_column('lok_scenario', 'image',
                      self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Scenario.portrait'
        db.delete_column('lok_scenario', 'portrait_id')

        # Deleting field 'Result.portrait'
        db.delete_column('lok_result', 'portrait_id')
