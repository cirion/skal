...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Character.recharge_delay_secs'
        db.add_column('lok_character', 'recharge_delay_secs',
                      self.gf('django.db.models.fields.IntegerField')(default=900),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Character.recharge_delay_secs'
        db.delete_column('lok_character', 'recharge_delay_secs')
