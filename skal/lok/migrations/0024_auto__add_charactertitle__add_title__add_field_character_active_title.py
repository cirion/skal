...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'CharacterTitle'
        db.create_table('lok_charactertitle', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('character', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['lok.Character'])),
            ('title', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['lok.Title'])),
        ))
        db.send_create_signal('lok', ['CharacterTitle'])

        # Adding model 'Title'
        db.create_table('lok_title', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('raw_title_male', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('raw_title_female', self.gf('django.db.models.fields.CharField')(max_length=100)),
        ))
        db.send_create_signal('lok', ['Title'])

        # Adding field 'Character.active_title'
        db.add_column('lok_character', 'active_title',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['lok.Title'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'CharacterTitle'
        db.delete_table('lok_charactertitle')

        # Deleting model 'Title'
        db.delete_table('lok_title')

        # Deleting field 'Character.active_title'
        db.delete_column('lok_character', 'active_title_id')
