...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Party'
        db.create_table('lok_party', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ))
        db.send_create_signal('lok', ['Party'])

        # Adding model 'PartyInvite'
        db.create_table('lok_partyinvite', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('from_character', self.gf('django.db.models.fields.related.ForeignKey')(related_name='party_invite_from', to=orm['lok.Character'])),
            ('to_character', self.gf('django.db.models.fields.related.ForeignKey')(related_name='party_invite_to', to=orm['lok.Character'])),
            ('party', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['lok.Party'])),
        ))
        db.send_create_signal('lok', ['PartyInvite'])

        # Adding field 'Character.party'
        db.add_column('lok_character', 'party',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['lok.Party']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'Party'
        db.delete_table('lok_party')

        # Deleting model 'PartyInvite'
        db.delete_table('lok_partyinvite')

        # Deleting field 'Character.party'
        db.delete_column('lok_character', 'party_id')
    ...
    models = {
        ...
        'lok.character': {
            ...
            'active_title': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['lok.Title']", 'null': 'True', 'blank': 'True'}),
            ...
            'contact': ('django.db.models.fields.IntegerField', [], {'default': '2'}),
            ...
            'party': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['lok.Party']"}),
            'player': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['auth.User']"}),
            'recharge_delay_secs': ('django.db.models.fields.IntegerField', [], {'default': '900'}),
        ...
        'lok.charactertitle': {
            'Meta': {'object_name': 'CharacterTitle'},
            'character': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['lok.Character']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'title': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['lok.Title']"})
        },
        'lok.choice': {
        ...
        'lok.image': {
            ...
            'alt': ('django.db.models.fields.CharField', [], {'max_length': '500'}),
            'contributor': ('django.db.models.fields.CharField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
            'contributor_link': ('django.db.models.fields.CharField', [], {'max_length': '200', 'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'lok.partyinvite': {
            ...
            'from_character': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'party_invite_from'", 'to': "orm['lok.Character']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'party': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['lok.Party']"}),
            'to_character': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'party_invite_to'", 'to': "orm['lok.Character']"})
        },
        'lok.plot': {
        ...
        'lok.result': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'portrait': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['lok.Image']", 'null': 'True', 'blank': 'True'}),
            'title': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
            'type': ('django.db.models.fields.IntegerField', [], {'default': '1'}),
        ...
        'lok.title': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'raw_title_female': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
            'raw_title_male': ('django.db.models.fields.CharField', [], {'max_length': '100'})
        }
    }
