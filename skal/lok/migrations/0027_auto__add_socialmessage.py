...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'SocialMessage'
        db.create_table('lok_socialmessage', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('to_character', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['lok.Character'])),
            ('created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('description', self.gf('django.db.models.fields.CharField')(max_length=1000)),
        ))
        db.send_create_signal('lok', ['SocialMessage'])


    def backwards(self, orm):
        # Deleting model 'SocialMessage'
        db.delete_table('lok_socialmessage')
