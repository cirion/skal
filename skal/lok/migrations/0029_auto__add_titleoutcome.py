...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'TitleOutcome'
        db.create_table('lok_titleoutcome', (
        ...
        db.send_create_signal('lok', ['TitleOutcome'])


    def backwards(self, orm):
        # Deleting model 'TitleOutcome'
        db.delete_table('lok_titleoutcome')
    ...
    models = {
        ...
        'lok.socialmessage': {
            'Meta': {'object_name': 'SocialMessage'},
            'created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'description': ('django.db.models.fields.CharField', [], {'max_length': '1000'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'to_character': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['lok.Character']"})
        },
        'lok.stat': {
